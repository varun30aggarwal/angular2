...
export class WorkoutRunnerComponent implements OnInit {
	...
	constructor() {
		// code..
		this.woroutPlan=this.buildWorkOut();
		this.restExercise=new ExercisePlan(new Exercise("rest","Relax!","Relax a bit","rest.png"),this.woroutPlan.restBetweenExercise);
	...
	start(){
 this.workoutTimeRemaining = this.woroutPlan.totalWorkoutDuration();
    this.currentExerciseIndex = 0;
    this.startExercise(this.woroutPlan.exercises[this.currentExerciseIndex]);
	}
...
{
	nextExercise=this.woroutPlan.exercises[this.currentExerciseIndex+1];
}
else if(this.currentExerciseIndex<this.woroutPlan.exercises.length-1)
{
...
let workout = new WorkOutPlan("7MinWorkout", "7 Min Workout", 10, []);
